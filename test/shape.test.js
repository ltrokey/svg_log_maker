...
describe("ShapeGenerator", () => {
  ...
  describe("Initialize Triangle & Color", () => {
    it("should set shape & color properly", () => {
      ...
      const expectedSvgContent = `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><polygon points="150,18 244,182 56,182" fill="${shapeColor}" />`;
      const shapeGenerator = new ShapeGenerator();
  ...
  describe("Initialize Circle & Color", () => {
    it("should set shape & color properly", () => {
      ...
      const expectedSvgContent = `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="100" r="80" fill="${shapeColor}" />`;
      const shapeGenerator = new ShapeGenerator();
      const svgShapeContent = shapeGenerator.generateSvgShape({
        shape,
        shapeColor,
  ...
  describe("Initialize Square & Color", () => {
    it("should set shape & color properly", () => {
      ...
      const expectedSvgContent = `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="25" width="150" height="150" fill="${shapeColor}" />`;
      const shapeGenerator = new ShapeGenerator();
      const svgShapeContent = shapeGenerator.generateSvgShape({
        shape,
        shapeColor,
